...
const navPrevious = document.querySelector('[data-slide="previous-button"]')
const navNext = document.querySelector('[data-slide="next-button"]')
...
function setListeners() {
    ...
    navPrevious.addEventListener('click', previousSlide)
