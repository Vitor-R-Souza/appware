...
(1, '465', '15', 'AMD Ryzen 5 PRO 4650G with Radeon Graphics', 'AMD Radeon Graphics Processor (0x1636)', 'Windows 10', 'etec', 'technology.ldr@gmail.com');
...
INSERT INTO `placa_video` (`id_placa`, `nome_placa`, `valor`) VALUES
(1, 'Nvidia GeForce GTX 1060 6GB', 100),
(2, 'AMD Radeon R9 290', 200),
(3, 'AMD RX 480', 300),
(4, 'Nvidia GeForce GTX 770', 400),
(5, 'AMD radeon graphics', 500),
(6, 'AMD Radeon HD 7870-GHz', 600),
(7, 'Nvidia GeForce GTX 660', 700);
...
INSERT INTO `processadores` (`id_processador`, `nome_processador`, `valor`) VALUES
(1, 'Intel CPU Core i5-2500K ', 100),
(2, 'Intel Core™ i7-4770K', 200),
(3, 'AMD Ryzen 5 PRO 4650G Graphics', 300),
(4, ' Intel CPU Core i7 3770 ', 400),
(5, 'AMD FX-8350', 500),
(6, 'AMD Ryzen 5 1500X', 600),
(7, 'AMD CPU Phenom II X4 940', 700);
