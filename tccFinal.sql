...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 08-Dez-2022 às 14:19
...
(1, '1000', '3', 'Intel(R) Pentium(R) Dual  CPU  E2180', 'Intel(R) G33/G31 Express Chipset Family', 'Windowns 10', 'PC 1', 'technology.ldr@gmail.com');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `site_empresa` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(13, 'ADMIN', 'admin', 'technology.ldr@gmail.com', 'Admin', '1995-07-11', 'LDR TECHNOLOGY', 'https://web.facebook.com/ldr.technology?_rdc=1&_rdr', '$2y$10$2dDOjvcZxMrpB8BIgpVoLOJP/A7wgkCC05q2InqpHqY9uS1cmByRW', 'profilepic/df2483f9d9aeb395810e2d9e1450674e.jpg', NULL, NULL),
