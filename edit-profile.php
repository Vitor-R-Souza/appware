                ...
                echo "<input type='hidden' name='tipo' value='Dev'>
                    ...
                    if(is_dev() or is_adm()){
                        ...
                        echo"<div class='box-user'>
                            ...
                            <div class='box-user'>
                                <input type='text' name='site-dev' id='site-dev' class='required' oninput='siteValidate()' value='$reg->site_empresa' required placeholder='Site/Página da Empresa/Estúdio'>
