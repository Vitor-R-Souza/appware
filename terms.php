...
<body>
    ...
    <main>
        ...
        <h3>Cookies:</h3>
        <p>O site usa cookies para ajudar na personalização da sua experiência na internet. Ao acessar o site Appware, você concorda com o uso dos cookies requeridos.</p>
        ...
        <h3>Licença:</h3>
        <p>Exceto em casos em que for indicado o contrário, Appware e seus licenciados têm direito à propriedade intelectual de todo o material postado no Appware. Todos os direitos à propriedade intelectual são reservados.</p>

        <p>Você não tem permissão para:</p>

        <ul>
            <li>Copiar ou republicar materiais do Appware</li>
            <li>Vender, alugar ou sublocar materiais do Appware</li>
            <li>Reproduzir, duplicar ou copiar materiais do Appware</li>
            <li>Redistribuir conteúdos do Appware</li>
            <li>Este Acordo terá efeito a partir da data presente.</li>
        </ul>

        <p>Partes deste site oferecem ao usuário a oportunidade de postar e discutir opiniões e informações em determinadas áreas. Appware não filtra, edita, publica ou revisa Comentários antes que eles sejam apresentados no site. Comentários refletem as opiniões da pessoa que os posta. Na extensão em que as leis aplicáveis permitem, Appware não se responsabiliza legalmente pelos Comentários ou quaisquer danos, riscos ou despesas causadas ou sofridas como resultado do uso, e/ou postagem e/ou aparência dos Comentários deste site.</p>

        <p>Appware reserva para si o direito de remover quaisquer Comentários que possam ser considerados inapropriados, ofensivos ou quebrem os Termos e Condições deste contrato.</p>
        ...
        <p>Você por meio deste concede a Appware a licença não-exclusiva de usar, reproduzir, editar e autorizar outros a usar, reproduzir ou editar qualquer um de seus Comentários em qualquer e todas as formas, formatos e mídias.</p>
        ...
        <p>Se você representa uma das organizações listadas no parágrafo 2 acima e está interessado em postar um link para nosso site, você deve nos informar de seu interesse enviando um e-mail para Appware. Por favor, inclua seu some, o nome da sua organização e suas informações de contato, assim como a URL do seu site, uma lista das URLs do nosso site que você pretende usar como links, e uma lista dos sites nos quais você pretende publicar nossas URLs. Aguarde entre 2 e 3 semanas para receber uma resposta.</p>
        ...
        <p>Não será permitido o uso ou a publicação de links para o logo e/ou outros elementos visuais da Appware sem um acordo de licença para o uso da marca registrada.</p>
